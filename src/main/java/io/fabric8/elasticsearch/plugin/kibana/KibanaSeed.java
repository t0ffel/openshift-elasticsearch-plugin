...
public class KibanaSeed implements ConfigurationSettings {
	...
	public void setDashboards(String user, Set<String> projects, Set<String> roles, Client esClient, String kibanaIndex, String kibanaVersion, final String project_prefix, final Settings settings) {
		...
		if ( indexPatterns.isEmpty() ) {
			create(user, sortedProjects, true, esClient, kibanaIndex, kibanaVersion, project_prefix, time_field_name);
			changed.set(true);
		}
		else {
			...
			create(user, sortedProjects, false, esClient, kibanaIndex, kibanaVersion, project_prefix, time_field_name);
	...
	private void create(String user, List<String> projects, boolean setDefault, Client esClient, String kibanaIndex, String kibanaVersion, String project_prefix, String time_field_name) {
		boolean defaultSet = !setDefault;
		
		for ( String project: projects ) {
			createIndex(user, project, esClient, kibanaIndex, project_prefix, time_field_name);
	...
	private void createIndex(String username, String project, Client esClient, String kibanaIndex, String project_prefix, String time_field_name) {
